...
function changeMenu(menuID){
	...
	switch(menuID){
		// 출입신청 020100
		case "20101":	srcPath = "app/custom/army_hq/accessApplication/accessApplicationManagement";	break;
		
		// 출입신청 조회/승인
		case "20201":	srcPath = "app/custom/army_hq/accessApplication/accessApplicationSearchAndApproval";	break;
		
		// 출입증 발급 020300
		case "20301":	srcPath = "app/custom/army_hq/accessCard/accessCardIssue";	break;
		case "20302": 	srcPath = "app/custom/army_hq/accessCard/tempCardIssue"; break;
		case "20303":	srcPath = "app/custom/army_hq/accessCard/accessCardPrintSetting";	break;
		//case "20304":	srcPath = "app/custom/army_hq/accessCard/accessCardIssueStatus";	break;
		//case "20305":	srcPath = "app/custom/army_hq/accessCard/tempCardIssueStatus";	break;
		
		//20305 임시 출입증 발급현황 빠져있음 
		// 출입증 교부/회수 020400
		case "20401":	srcPath = "app/custom/army_hq/accessCard/accessCardIssuance";			break;	// 출입증 교부
		case "20402":	srcPath = "app/custom/army_hq/accessCard/civilServiceCardRegist";		break;	// 공무원증 등록	
		case "20403":   srcPath = "app/custom/army_hq/accessCard/tempCardIssuance";				break;	// 임시출입증 교부
		case "20404":	srcPath = "app/custom/army_hq/accessCard/accessCardRetrieve";			break;	// 출입증 회수
		case "20405":   srcPath = "app/custom/army_hq/accessCard/tempCardRetrieve";			break;	// 임시출입증 회수		
		case "20406":	srcPath = "app/custom/army_hq/accessCard/accessCardIncidentHandling";	break;	// 출입증 사고처리
		case "20407":	srcPath = "app/custom/army_hq/accessCard/narasarangCardRegist";		break;	// 나라사랑카드 등록
		
		// 출입증 현황 020500
		case "20501":	srcPath = "app/custom/army_hq/accessCard/accessCardIssuanceStatus";	break;
		case "20502":	srcPath = "app/custom/army_hq/accessCard/civilServiceCardRegistStatus";	break;
		case "20503":	srcPath = "app/custom/army_hq/accessCard/narasarangCardRegistStatus";	break;
		
		// 소속 부대원 정보 관리
		case "20601":
			if (privilege == 1 ) {
				srcPath = "app/custom/army_hq/users/userManagement";	
			} else {
				srcPath = "app/custom/army_hq/users/ModifyUserInformation";
			}
			break;
		case "20602":	srcPath = "app/custom/army_hq/users/moveOutStatus";	break;
		
		// 부대차량 등록 관리 020700
		case "20701":	srcPath = "app/custom/army_hq/lpr/UnitCarInformationRegist";	break;
		case "20702":	srcPath = "app/custom/army_hq/lpr/UnitCarInformationModify";	break;
	}	
