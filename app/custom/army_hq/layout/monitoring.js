...
function changeMenu(menuID){
	...
	switch(menuID){
		//사무실 출입문 제어
		case "50101":	srcPath = "app/custom/army_hq/monitoring/monitoringManagement";	AMML_monitoring_id = 50101; break; //사무실 출입문 제어
		//중앙관제
		case "50201":	srcPath = "app/custom/army_hq/monitoring/locationShape"; AMML_monitoring_id = 50201;	break;
		default:
			return;
	}	
...
exports.onLocationMonitoringCalled = function(id){
	...
	var embView = app.lookup("AMML_eaMainView");
	cpr.core.App.load("app/custom/army_hq/monitoring/locationMonitoring", function(app){
		if(app){			
