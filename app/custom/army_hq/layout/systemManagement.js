...
function changeMenu(menuID, param){
	...
	switch(menuID){
		...
		case "60102":	srcPath = "app/custom/army_hq/system/privilegeManagement";	break; //권한관리	
		case "60103":	srcPath = "app/custom/army_hq/system/systemUserManagement";	break; //시스템 사용자 관리		
		case "60104":	srcPath = "app/custom/army_hq/system/approverManagement";	break; //승인자 관리
			
		// 시스템 설정
		case "60201":	srcPath = "app/custom/army_hq/system/GroupManagement";		break;//부서관리			
		case "60202":	srcPath = "";												break; //코드관리			
		case "60203":	srcPath = "app/custom/army_hq/system/locationAreaShape";	break; //장소도면관리					
		// case "60204":	srcPath = "app/main/position/positionManagement";			break; //직급관리
		case "60205":	srcPath = "app/custom/army_hq/system/siteNameManagement";	break; //부대명 관리
		case "60206":	srcPath = "app/custom/army_hq/system/AccessApprovalSetting";	break; //출입신청 결제 설정
		case "60207": srcPath = "app/custom/army_hq/system/setUserPassword";	break; //관리자 기본 패스워드 설정
		// 접속이력 조회
		case "60301":	srcPath = "app/custom/army_hq/system/AuditLogManagement";			break; //접속이력조회			
			
		// 로그 조회
		case "60401":	srcPath = "app/custom/army_hq/system/eventLogManagement";			break; //이벤트로그조회
			
		// 공지사항
		case "60500":	srcPath = "app/custom/army_hq/notice/noticeManagement";		break;	
		case "60501":	srcPath = "app/custom/army_hq/notice/noticeRegist";		break;		
		case "60502":	srcPath = "app/custom/army_hq/notice/noticeView";		break;
		case "60503":	srcPath = "app/custom/army_hq/notice/noticeModify";		break;
		
		case "60600":	hostAppIns.callAppMethod("closeUI"); return;
		case "60700":	srcPath = "app/custom/army_hq/system/adminLoginStatusManagement";		break;
		case "60800":	srcPath = "app/custom/army_hq/system/adminUserIpManagement";		break;
		default:		return;
	}	
...
function onLOFile_btnHiddenClick(/* cpr.events.CMouseEvent */ e){
	...
	var srcPath = "app/custom/army_hq/system/ServerLogDownload";
	if( srcPath.length > 0 ){cpr.core.App.load( srcPath , function(app){
		if(app){
			embView.app = app;
			embView.ready(function(){ 
