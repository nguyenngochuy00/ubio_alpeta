...
function onBodyLoad(/* cpr.events.CEvent */ e){
	...
	if (reqType == 0) {
		...
		app.lookup("JWDLR_ipbDeviceID").inputFilter = "[0-9]"; // 아이디는 숫자만 입력 가능
	} else {
		app.lookup("JWDLR_ipbDeviceID").readOnly = true;
		app.lookup("JWDLR_ipbDeviceID").style.css("border", "none");
