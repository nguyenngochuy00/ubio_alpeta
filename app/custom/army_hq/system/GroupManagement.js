...
function onBodyLoad(/* cpr.events.CEvent */ e){
	...
	udcUserTerminal.deleteUserColumn([14,13,12,11,10,9,8,7,6,5,4,1]);
	...
	udcUserTerminal.setSelectedGroup(loginUserGroupCode);
	udcUserTerminal.setExpandAllItems();
	//udcUserTerminal.setContextmenu();
	if ((dataManager.getOemVersion() == OEM_ARMY_HQ || dataManager.getOemVersion() == OEM_ROKMCH) && isLoginMaster()) {
