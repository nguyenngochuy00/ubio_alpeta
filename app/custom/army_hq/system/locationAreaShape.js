...
function onFi1ValueChange(/* cpr.events.CValueChangeEvent */ e){
	...
	if (fi1.files.length > 0 ) { 
		...
		|| ext.toUpperCase()== "PJPEG" || ext.toUpperCase()== "AVIF") {
			...
			dialogAlertAMHQ(app, dataManager.getString("Str_Warning"), dataManager.getString("Str_ErrorNotImageFileExtension"));
			fi1.clear();
		}
	}
}
...
function createDragIcon(id, name, left, top){
		...
		if(row.getValue("Type") == ""){
			dialogAlertAMHQ(app, dataManager.getString("Str_Failed"), dataManager.getString("Str_UnconnectedTerminal"));
		}
		*/
		
		switch(row.getValue("Type")){
			
			case 2: src = "theme/images/terminals/AC2000.png"; break;//return "NAC 2500";  break;
			case 3: src = "theme/images/terminals/AC2000.png"; break;//return "NAC 3000";  break;
			case 4: src = "theme/images/terminals/AC2000.png"; break;//return "NAC 2500 (4MF)";  break;			
			case 6: src = "theme/images/terminals/AC2000.png"; break;//return "NAC 5000"; break;			
			case 9: src = "theme/images/terminals/AC2000.png"; break;//return "NAC 1500";  break;			
			case 18: src = "theme/images/terminals/eNBioAccess-T5.png"; break;//return "T5"; break;
			case 19: src = "theme/images/terminals/eNBioAccess-T3.png"; break;//return "T3";break;
			case 20: src = "theme/images/terminals/eNBioAccess-T1.png"; break;//return "T1"; break;			
			case 22: src = "theme/images/terminals/eNBioAccess-T9.png"; break;//return "T9"; break;
			case 23: src = "theme/images/terminals/AC2000.png"; break;//return "FKA2"; break;
			case 24: src = "theme/images/terminals/eNCardi.png"; break;//return "eNCardi"; break;
			case 25: src = "theme/images/terminals/eNBioAccess-T2.png"; break;//return "T2"; break;
			
			case 26: src = "theme/images/terminals/UBio-X_Slim.png"; break;//return "UBio-X Slim"; break;
			case 30: src = "theme/images/terminals/AC1100.png"; break;//return "AC1100"; break;
			case 31: src = "theme/images/terminals/AC2000.png"; break;//return "AC2000"; break;
			case 32: src = "theme/images/terminals/AC2200&2100.png"; break;//return "AC2200"; break;
			case 33: src = "theme/images/terminals/AC5100&5000PLUS.png"; break;//return "AC5000"; break;
			case 34: src = "theme/images/terminals/AC5100&5000PLUS.png"; break;//return "AC5100"; break;
			case 35: src = "theme/images/terminals/AC7000.png"; break;//return "AC7000";break;
			case 36: src = "theme/images/terminals/UBio-X_Pro.png"; break;//return "UBio-X Pro Lite"; break;
			case 37: src = "theme/images/terminals/UBio-X_Pro.png"; break;//return "UBio-X Pro"; break;
			case 38: src = "theme/images/terminals/AC6000.png"; break;//return "AC6000"; break;
			case 39: src = "theme/images/terminals/UBioTablet5.png"; break;//return "UBio Tablet5"; break;
			case 40: src = "theme/images/terminals/UBio-X_Slim.png"; break;//return "UBio-X_Slim"; break;			
			case 41: src = "theme/images/terminals/UBio-X_Pro.png"; break;//return "UBio-X_Pro2"; break;
			case 42: src = "theme/images/noImg.gif"; break;
			case 43: src = "theme/images/terminals/UBio-X_Iris.png"; break;//return "UBio-X_ProIris
			case 44: src = "theme/images/terminals/AC2200&2100.png"; break;//return "AC2100 PLUS
			case 45: src = "theme/images/terminals/UBio-X Face.png"; break;
...
function deleteIcon(code, id){
	...
	smsDeleteMapAreaTerminal.addEventListenerOnce("submit-done", function(){
		...
		if(resultCode == COMERROR_NONE){
			...
			dialogAlertAMHQ(app, dataManager.getString("Str_Info"), dataManager.getString(getErrorString(resultCode)), "");
		}
	});
}
...
function onVMTMS_btnSaveClick(/* cpr.events.CMouseEvent */ e){
	...
	var imageData = areaImage.src.replace(/^data:image\/(png|jpg|jpeg);base64,/, "");
	// png, jpg, jpeg 파일만 등록 가능
...
function onSms_registMapAreaInfoSubmitDone(/* cpr.events.CSubmissionEvent */ e){
	...
	if(resultCode==COMERROR_NONE){
		...
		//dialogAlertAMHQ(app, "Submission Error", resultCode, "");
		dialogAlertAMHQ(app, "Submission Error", dataManager.getString(getErrorString(resultCode)), "");
	}
}
