...
function initComboAuthLogColumn() {
	...
	if (cmdAll) {
		...
		cmdAll.addItem(new cpr.controls.Item(dataManager.getString("Str_PassportNo"), "PassportNo"));
		cmdAll.addItem(new cpr.controls.Item(dataManager.getString("Str_IqamaNo"), "IqamaNo"));
		cmdAll.addItem(new cpr.controls.Item(dataManager.getString("Str_BloodType"), "BloodID"));
		cmdAll.addItem(new cpr.controls.Item(dataManager.getString("Str_MobileNum"), "Mobile"));
		cmdAll.addItem(new cpr.controls.Item(dataManager.getString("Str_Remarks"), "Remarks"));
		cmdAll.addItem(new cpr.controls.Item(dataManager.getString("Str_InOutput"), "Latitude"));
	}
	...
	if (cmdSelect) {
		...
		cmdSelect.addItem(new cpr.controls.Item(dataManager.getString("Str_PassportNo"), "PassportNo"));
		cmdSelect.addItem(new cpr.controls.Item(dataManager.getString("Str_IqamaNo"), "IqamaNo"));
		cmdSelect.addItem(new cpr.controls.Item(dataManager.getString("Str_BloodType"), "BloodID"));
		cmdSelect.addItem(new cpr.controls.Item(dataManager.getString("Str_MobileNum"), "Mobile"));
		cmdSelect.addItem(new cpr.controls.Item(dataManager.getString("Str_Remarks"), "Remarks"));
		cmdSelect.addItem(new cpr.controls.Item(dataManager.getString("Str_InOutput"), "Latitude"));
	}
}
