...
function groupNameByTerminal(groupCode) {
	return dataManager.getGroupName(groupCode);
}
cpr.expression.ExpressionEngine.INSTANCE.registerFunction("groupNameByTerminal", groupNameByTerminal);
...
function initComboAuthLog() {
	...
	if (dataManager.getOemVersion() == OEM_JAWOONDAE || dataManager.getOemVersion() == OEM_HYUNDAI_MSEAT) {
...
exports.addAuthLog = function(authLog) {
	...
	if( tInfo == null && authLog.AuthType != 9999 ){return;} 
						...
						configurator: function(cell){
							...
							cell.style.bind("color").toExpression([
									...
									cell.control = (function(){
										...
										comboBox_1.style.css("text-align","center");
										return comboBox_1;
									})();
									}
									...
									cell.control = (function(){
										...
										comboBox_2.style.css("text-align","center");
										return comboBox_2;
									})();
									}
									if(selectArr[i] == "Func"){
									cell.control = (function(){
										...
										comboBox_3.style.css("text-align","center");
										return comboBox_3;
									})();
									}
									...
									cell.control = (function(){
										...
										comboBox_4.style.css("text-align","center");
										return comboBox_4;
									})();
									}
						}
