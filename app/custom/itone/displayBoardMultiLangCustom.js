...
function onBodyLoad( /* cpr.events.CEvent */ e) {
	...
	dm_returnValue.setValue("font_size", localStorage.getItem("displayBoard_FontSize"));
	dm_returnValue.setValue("popup_count", localStorage.getItem("displayBoard_PopUpCount"));
...
function onButtonClick( /* cpr.events.CMouseEvent */ e) {
	...
	if (returnValue.getValue("font_size") == null) {
		returnValue.setValue("font_size",50);
	}
	if (returnValue.getValue("popup_count") == null) {
		returnValue.setValue("popup_count", 0);
	}
