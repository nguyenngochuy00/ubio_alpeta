...
//		embDetailPage.app = null;	
		var url = "app/custom/rokmch/areaNDeviceManagement/accessGroupInfoPage" + "?" + usint_version;
...
function onTreeAccessGroupSelectionChange(/* cpr.events.CSelectionEvent */ e){
	...
	if (treeGroup.parentValue == "0") {
		...
		url = "app/custom/rokmch/areaNDeviceManagement/accessGroupInfoPage";
		...
		url = "app/custom/rokmch/areaNDeviceManagement/AccessAreaInfoPage";
