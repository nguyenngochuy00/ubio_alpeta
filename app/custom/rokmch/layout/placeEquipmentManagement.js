...
function changeMenu(menuID){
	...
	switch(menuID){
		// 장소관리
		case "40101":	//장소관리
			srcPath = "app/custom/rokmch/accessStatus/AccessStatusAreaSetting";	break;
		case "40102":	//출입권한관리
			srcPath = "app/custom/rokmch/areaNDeviceManagement/AccessGroupUserManagement";	break;
		case "40103":	//출입구역관리
			srcPath = "app/custom/rokmch/areaNDeviceManagement/accessAreaManagement";	break;
		case "40104":	//출입그룹관리
			srcPath = "app/custom/rokmch/areaNDeviceManagement/accessGroupManagement";	break;						
		//장비관리
		case "40201":	//장비관리
			srcPath = "app/custom/rokmch/areaNDeviceManagement/terminalManagement";	break;
		case "40202":	//장바사용자관리
			srcPath = "app/custom/rokmch/areaNDeviceManagement/terminalUser";		break;
		case "40203":	//LPR 관리
			srcPath = "app/custom/rokmch/lpr/lprManagement";	break;
		// 군사통제구역관리(안티패스백)
		case "40301" : // 안티패스백 관리
		 	srcPath = "app/custom/rokmch/antipassbackAreaManagement/antipassbackManagement";	break;
		case "40302" : // 안티패스백 재실현황
			srcPath = "app/custom/rokmch/antipassbackAreaManagement/antipassbackAreaUseInfo";	break;
		default:
			return;
	}	
