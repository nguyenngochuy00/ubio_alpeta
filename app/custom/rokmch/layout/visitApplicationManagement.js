...
function changeMenu(menuID){
	...
	switch(menuID){
		// 방문신청
		case "10101":	srcPath = "app/custom/rokmch/visitApplication/VisitApplicationPreviousness";	break;
		case "10102":	srcPath = "app/custom/rokmch/visitApplication/VisitApplicationBatch";	break;
		case "10103":	srcPath = "app/custom/rokmch/visitApplication/VisitApplicationField";	break;

		// 방문신청 조회/승인
		case "10201":	srcPath = "app/custom/rokmch/visitApplication/VisitApplicationSearch";	break;
		case "10202":	srcPath = "app/custom/rokmch/visitApplication/VisitApplicationSearchAndApproval";	break;
		
		// 방문증 교부/회수
		case "10301":	srcPath = "app/custom/rokmch/visitCard/visitCardIssuance";	break; // 방문증 교부
		case "10302":	srcPath = "app/custom/rokmch/visitCard/visitCardRetrieve";	break; // 방문증 회수
		case "10303":	srcPath = "app/custom/rokmch/visitCard/visitCardIncidentHandling";	break; // 방문증 사고처리
			
		// 방문증 관리
		case "10401":	srcPath = "app/custom/rokmch/visitCard/visitCardIssue";	break; // 방문증 발급	
		case "10402":	srcPath = "app/custom/rokmch/visitCard/visitCardIssueStatus";	break; // 방문증 발급현황
		case "10404":	srcPath = "app/custom/rokmch/visitCard/visitCardPrintSetting";	break; // 방문증인쇄 환경설정
	
		// 방문증 상세현황
		case "10501":	srcPath = "app/custom/rokmch/visitCard/visitCardIssuanceStatus";	break; // 방문증 교부 현황
		case "10502":	srcPath = "app/custom/rokmch/visitCard/visitCivilServiceCardRegistStatus";	break; // 방문증 공무원증 등록 현황
		case "10503":	srcPath = "app/custom/rokmch/visitCard/visitCardAllStatus";	break; // 방문증 전체현황
		case "10504":	srcPath = "app/custom/rokmch/visitCard/visitCardIssuanceLogs";	break; // 방문증 이력조회
		
		case "10601":	srcPath = "app/custom/rokmch/documentArchive/accessBatchRegist";	break; // 출입자 일괄등록
		case "10602":	srcPath = "app/custom/rokmch/documentArchive/accessorSearhNModify";	break; // 출입자 조회/수정
		case "10603":	srcPath = "app/custom/rokmch/documentArchive/accessPrivilegeRegist";	break; // 출입권한 등록
		case "10604":	srcPath = "app/custom/rokmch/documentArchive/accessPrivilegeRelease";	break; // 출입권한 해제
		case "10605":	srcPath = "app/custom/rokmch/documentArchive/inUserStatus";	break; // 입실자 현황
