...
function onBodyLoad( /* cpr.events.CEvent */ e) {
	...
	var count = getGroupLinkCombBoxCount();
	console.log(count);
	switch(count){
		case 3 :
			width = "500px";
	...
	app.lookup("USMAG_searchGroup1").getLayout().setColumns(["1fr", "60px", "30px", "50px", width, "75px", "100px"]);		
	...
	cmbUserGroup.setItemSet(dsGroupList, {label: "Name",	value: "GroupID" });
...
//    }
	...
	grdCmdGroup.setItemSet(dsGroupList, {label: "Name",	value: "GroupID" });
...
//	}
	...
	var udcGroupCmb = app.lookup("USMGR_udcGroupLDB");
	var gorupID = udcGroupCmb.getSelectionValue();

	smsGetUserList.setParameters("group", gorupID);
...
function onUSINB_btnFPInfoClick(){
	...
	app.openDialog("app/custom/rokmch/users/userFPInfo", {width : 440, height : 180}, function(dialog){
