/************************************************
 * AuthLogGrid.js
 * Created at 2024. 11. 13. 오전10:38:24.
 *
 * @author 960405
 ************************************************/
...
function onBodyLoad(/* cpr.events.CEvent */ e) {
  ...
  var selectStorage = localStorage.getItem("selectStorage_authLogExport");
  var grdStorage = localStorage.getItem("grdStorage_authLogExport");
  ...
  if (selectStorage == null) {
    ...
    for (var b = 0; b < selectcount; b++) {
      dsOrderList.addRowData({
        Value: selectString[b],
      });
    }
  }
...
function onMG_grdColumnListMouseup(/* cpr.events.CMouseEvent */ e) {
  ...
  if (dataDragManager.dataTransfer) {
    ...
    var targetIndex =
      e.targetObject != null ? e.targetObject.rowIndex : dsColumn.getRowCount();
    if (dataDragManager.dataTransfer["Src"] === "order") {
      ...
      dsColumn.insertRowData(targetIndex, false, {
        Value: value,
      });
    }
...
function onMG_grdOrderistMouseup(/* cpr.events.CMouseEvent */ e) {
  ...
  if (dataDragManager.dataTransfer) {
    ...
    var targetIndex =
      e.targetObject != null ? e.targetObject.rowIndex : dsOrder.getRowCount();
    if (dataDragManager.dataTransfer["Src"] === "column") {
      ...
      dsOrder.insertRowData(targetIndex, false, {
        Value: value,
      });
    } else {
...
function onButtonClick(/* cpr.events.CMouseEvent */ e) {
  ...
  if (grdOrderCount == 0 || grdOrderCount == null) {
    dialogAlert(
      app,
      dataManager.getString("Str_Fail"),
      dataManager.getString("Str_ErrorColumnselection")
    );
    return;
  }
...
function initComboAuthLogColumn() {
  ...
  if (cmdAll) {
    ...
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_UserID"), "UserID")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_UserName"), "UserName")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_UniqueID"), "UniqueID")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_AuthType"), "AuthType")
    );
    cmdAll.addItem(
      new cpr.controls.Item(
    ...
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_Func"), "Func")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_FuncType"), "FuncType")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_Card"), "Card")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_Detail"), "Detail")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_ExtraDevice"), "Dummy")
    );
    cmdAll.addItem(
      new cpr.controls.Item(
    ...
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_GroupName"), "GroupCode")
    );
    cmdAll.addItem(
      new cpr.controls.Item(
        dataManager.getString("Str_PositionName"),
        "PositionName"
      )
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_IsPicture"), "IsPicture")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_Latitude"), "Latitude")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_Longitude"), "Longitude")
    );
    cmdAll.addItem(
      new cpr.controls.Item(dataManager.getString("Str_Property"), "Property")
    );
  }
...
function onButtonClick2(/* cpr.events.CMouseEvent */ e) {
   ...
   */
  var button = e.control;
  var grdStorage = localStorage.getItem("grdStorage_authLog");
  dialogConfirm(
    app,
    dataManager.getString("Str_Complete"),
    dataManager.getString("Str_ColumnDialog"),
    function (/*cpr.controls.Dialog*/ dialog) {
...
function onButtonClick3(/* cpr.events.CMouseEvent */ e) {
  ...
  for (var a = 0; a < selectcount; a++) {
    ...
    dsOrder.insertRowData(result, true, {
      Value: value,
    });
  }
  ColumnList.redraw();
...
function onButtonClick4(/* cpr.events.CMouseEvent */ e) {
  ...
  for (var a = 0; a < selectcount; a++) {
    ...
    dsColumn.insertRowData(result, true, {
      Value: value,
    });
  }
  SelectList.redraw();
