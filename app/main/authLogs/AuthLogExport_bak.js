		...
		for (var i = 0; i < count; i++) {
			...
			if (logInfo.getValue("ReserveType") == 1) {
				...
				if( reservData.length>4 ){
					...
					var temp = "";
 					if( data[1]== 1){temp = dataManager.getString("Str_Mask")+ " ";	}
 					else if( data[1]== 2){
 					...
 					if( temperatureUnit == 0 ){logInfo.setValue("Detail", temp+"℃");}
 					else if( temperatureUnit == 1 ){logInfo.setValue("Detail", temp+"℉");}
				}
...
function getFuncValue(value){
	var result = "";
	switch(Number(value)){
		case 1: result = dataManager.getString("Str_FKeyF1"); break;
		case 2: result = dataManager.getString("Str_FKeyF2"); break;
		case 3: result = dataManager.getString("Str_FKeyAccess"); break;
		case 4: result = dataManager.getString("Str_FKeyF3"); break;
		case 5: result = dataManager.getString("Str_FKeyF4"); break;
		
		case 11: result = dataManager.getString("Str_FKeyAttend"); break;
		case 12: result = dataManager.getString("Str_FKeyLeave"); break;
		case 13: result = dataManager.getString("Str_FKeyAccess"); break;
		case 14: result = dataManager.getString("Str_FKeyOut"); break;
		case 15: result = dataManager.getString("Str_FKeyIn"); break;
		
		case 21: result = dataManager.getString("Str_FKeyMenu1"); break;
		case 22: result = dataManager.getString("Str_FKeyMenu2"); break;
		case 23: result = dataManager.getString("Str_FKeyMenu5"); break;
		case 24: result = dataManager.getString("Str_FKeyMenu3"); break;
		case 25: result = dataManager.getString("Str_FKeyMenu4"); break;	
	}
	return result;
}
...
function getLogFuncKey(value) {
	var key = "";
	switch (value) {
		case 1: key = dataManager.getString("Str_FKeyF1"); break;
		case 2: key = dataManager.getString("Str_FKeyF2"); break;
		case 3: key = dataManager.getString("Str_FKeyAccess"); break;
		case 4: key = dataManager.getString("Str_FKeyF3"); break;
		case 5: key = dataManager.getString("Str_FKeyF4"); break;
		case 11: key = dataManager.getString("Str_FKeyAttend"); break;
		case 12: key = dataManager.getString("Str_FKeyLeave"); break;
		case 13: key = dataManager.getString("Str_FKeyAccess"); break;
		case 14: key = dataManager.getString("Str_FKeyOut"); break;
		case 15: key = dataManager.getString("Str_FKeyIn"); break;
		case 21: key = dataManager.getString("Str_FKeyMenu1"); break;
		case 22: key = dataManager.getString("Str_FKeyMenu2"); break;
		case 23: key = dataManager.getString("Str_FKeyMenu5"); break;
		case 24: key = dataManager.getString("Str_FKeyMenu3"); break;
		case 25: key = dataManager.getString("Str_FKeyMenu4"); break;
		case 63: key = dataManager.getString("Str_FKeyAccess"); break;
		default:
			type = "";
			break;
	}
...
function processExportExcel(fileNum, offset,limit) {
	var locale = dataManager.getLocale();
	var InputData;
	var dsExportList = app.lookup("ExportAuthLogList");
	var total = dsExportList.getRowCount();
	if( limit>=total){limit = total-1}
		
	var stringified = JSON.stringify(dsExportList.getRowDataRanged(offset,limit));		
	...
	stringified = stringified.replace(/"UserName"/gi, '"'+dataManager.getString("Str_UserName")+'"');
	...
	stringified = stringified.replace(/"AuthType"/gi, '"'+dataManager.getString("Str_AuthType")+'"');
	stringified = stringified.replace(/"AuthResult"/gi, '"'+dataManager.getString("Str_AuthResult")+'"');
	stringified = stringified.replace(/"Func"/gi, '"'+dataManager.getString("Str_Func")+'"');
	stringified = stringified.replace(/"FuncType"/gi, '"'+dataManager.getString("Str_FuncType")+'"');
	stringified = stringified.replace(/"Card"/gi, '"'+dataManager.getString("Str_CardNum")+'"');
	stringified = stringified.replace(/"IsPicture"/gi, '"'+dataManager.getString("Str_IsPicture")+'"');
	stringified = stringified.replace(/"Latitude"/gi, '"'+dataManager.getString("Str_Latitude")+'"');
	stringified = stringified.replace(/"Longitude"/gi, '"'+dataManager.getString("Str_Longitude")+'"');
	stringified = stringified.replace(/"Property"/gi, '"'+dataManager.getString("Str_Property")+'"');
	stringified = stringified.replace(/"ServerRecordTime"/gi, '"'+dataManager.getString("Str_ServerRecordTime")+'"');
	stringified = stringified.replace(/"Detail"/gi, '"'+dataManager.getString("Str_Detail")+'"');
	stringified = stringified.replace(/"Dummy"/gi, '"'+dataManager.getString("Str_ExtraDevice")+'"');
...
function exportExcel() {
	...
	var limit = 1000000; 
	var fileCount = Math.ceil(total / limit);
		
	for( var i = 0; i < fileCount ; i++){
		processExportExcel(i,i*limit,i*limit+limit-1);
	}	
}
