 ...
 * 통신이 성공하면 발생합니다.
 */
function onSms_get_terminal_infoSubmitSuccess(/* cpr.events.CSubmissionEvent */ e){
	/** 
 ...
 * 통신이 성공하면 발생합니다.
 */
function onSms_get_terminal_optionSubmitSuccess(/* cpr.events.CSubmissionEvent */ e){
	/** 
	 * @type cpr.protocols.Submission
	 */
	var sms_get_terminal_option = e.control;
 ...
 * 통신이 성공하면 발생합니다.
 */
function onSms_set_terminal_infoSubmitSuccess(/* cpr.events.CSubmissionEvent */ e){
	/** 
	 * @type cpr.protocols.Submission
	 */
 ...
 * 통신이 성공하면 발생합니다.
 */
function onSms_setTerminal_optionSubmitSuccess(/* cpr.events.CSubmissionEvent */ e){
	/** 
	 * @type cpr.protocols.Submission
	 */
	var sms_setTerminal_option = e.control;
