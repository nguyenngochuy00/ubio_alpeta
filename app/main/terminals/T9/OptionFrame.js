...
function onBodyLoad(/* cpr.events.CEvent */ e){
	...
	if (hostAppIns) {
//		var tInfo = app.getHostProperty("initValue");
		var initValue = app.getHost().initValue;
		var requestData = app.lookup("sms_get_terminal_info");
		
//		terminalID = String(tInfo["ID"]);
 ...
 * 통신이 성공하면 발생합니다.
 */
function onSms_set_terminal_option_networkSubmitSuccess(/* cpr.events.CSubmissionEvent */ e){
	/** 
	 * @type cpr.protocols.Submission
	 */
	var sms_set_terminal_option_network = e.control;
	console.log("onSms_set_terminal_option_networkSubmitSuccess");
...
function onSms_get_terminal_infoSubmitDone(/* cpr.events.CSubmissionEvent */ e){
	...
	if(ResultCode == COMERROR_NONE) {
		...
		app.lookup("TMDT9_grpTerminalInfo").redraw();		
		// 초기 데이터에 저장
...
function onSms_set_terminal_infoSubmitDone(/* cpr.events.CSubmissionEvent */ e){
	...
	var ResultCode = app.lookup("Result").getValue("ResultCode");
	if(ResultCode == COMERROR_NONE) {
		var sms_set_terminal_info = e.control;
		console.log("onSms_set_terminal_infoSubmitSuccess"); 
...
//-------------------------------------------------------------------------------< end set_terminal_info
//-------------------------------------------------------------------------------> set_terminal_option_network
function onSms_set_terminal_option_networkSubmitDone(/* cpr.events.CSubmissionEvent */ e){
	var ResultCode = app.lookup("Result").getValue("ResultCode");
	if(ResultCode == COMERROR_NONE) {
		console.log("onSms_set_terminal_option_networkSubmitDone");
...
//-------------------------------------------------------------------------------< end set_terminal_option_network
//-------------------------------------------------------------------------------> set_terminal_option_system_config
function onSms_set_terminal_option_system_configSubmitDone(/* cpr.events.CSubmissionEvent */ e){
	var ResultCode = app.lookup("Result").getValue("ResultCode");
	if(ResultCode == COMERROR_NONE) {
		console.log("onSms_set_terminal_option_system_configSubmitSuccess");
...
//-------------------------------------------------------------------------------< end set_terminal_option_system_config
//-------------------------------------------------------------------------------> set_terminal_option_display_config

function onSms_set_terminal_option_display_configSubmitDone(/* cpr.events.CSubmissionEvent */ e){
	var ResultCode = app.lookup("Result").getValue("ResultCode");
	if (ResultCode == COMERROR_NONE) {
		console.log("onSms_set_terminal_option_display_configSubmitSuccess");
...
//-------------------------------------------------------------------------------< end set_terminal_option_display_config
 ...
 * 사용자가 컨트롤을 클릭할 때 발생하는 이벤트.
 */
function onTMDT9_SaveClick(/* cpr.events.CMouseEvent */ e){
...
function onTMDT9_DeleteClick(/* cpr.events.CMouseEvent */ e){
...
function onSms_set_terminal_option_setting_configSubmitDone(/* cpr.events.CSubmissionEvent */ e){
	console.log("onSms_set_terminal_option_setting_configSubmitSuccess");
