...
var curTerminalID = 0;
exports.getCurTerminalID = function() {
	return curTerminalID; 
}	

exports.hideLoadMask = function() {
...
function changePage(selectedButton) {
	...
	if( false )
	{
		//url = "app/main/terminals/optionMCP/terminalMCPPageReader" + "?" + usint_version;
		//url = "app/main/terminals/optionMCP/terminalMCPPagePartition" + "?" + usint_version;
		//url = "app/main/terminals/optionMCP/terminalMCPPageZone" + "?" + usint_version;
		//url = "app/main/terminals/optionMCP/terminalMCPPageSystem" + "?" + usint_version;
		//url = "app/main/terminals/optionMCP/terminalMCPPageNetwork" + "?" + usint_version;
		//url = "app/main/terminals/optionMCP/terminalMCPPageIO" + "?" + usint_version;
		//url = "app/main/terminals/optionMCP/terminalMCPPageLockSetting" + "?" + usint_version;
		//url = "app/main/terminals/optionMCP/terminalMCPPageLock" + "?" + usint_version;
		//url = "app/main/terminals/optionMCP/terminalMCPPageSchedule" + "?" + usint_version;
		//url = "app/main/terminals/optionMCP/terminalMCPPageHoliday" + "?" + usint_version;
		
		url = "app/main/terminals/optionMCP/AcuDetailStatus" + "?" + usint_version;
...
function onSms_get_terminal_infoSubmitDone(/* cpr.events.CSubmissionEvent */ e){
	...
	if (getType == 35 || getType == 30) {
		app.lookup("").visible = true;	
	} else {
		app.lookup("").visible = false;
	}
	...
	*/	
	...
	console.log("onSms_get_terminal_infoSubmitDone");
}
...
function SendTransferItemstoTerminal() {
	...
	if (embAppIns) {
		if (embAppIns.hasAppMethod("requestSaveData")) {
			embAppIns.callAppMethod("requestSaveData");		
		}	
	} else {
		dialogAlert(app, dataManager.getString("Str_Success"), dataManager.getString("Str_TerminalSaveSuccess"));
...
// 리더 버튼 클릭시 
function onTMVBA_btnCardReaderTypeClick(/* cpr.events.CMouseEvent */ e){
	var tMVBA_btnCardReaderType = e.control;
	
	var TerminalID = app.lookup("TerminalInfo").getValue("ID");
	var appld = "app/main/terminals/optionMCP/terminalMCPPageTerminalNameSet"
	app.openDialog(appld, {width : 800, height : 450}, function(dialog){
		dialog.bind("headerTitle").toLanguage("Str_ReaderNameSet");
		dialog.modal = true;
		dialog.initValue = {"terminalID": app.lookup("TerminalInfo").getValue("ID")}
		})
	}