...
function sendUserListRequestAll() {
	...
	smsGetUserList.addEventListenerOnce("submit-done", onSms_getUserListAllSubmitDone);
	smsGetUserList.addEventListenerOnce("submit-error", onSms_getUserListAllSubmitError);
	smsGetUserList.addEventListenerOnce("submit-timeout", onSms_getUserListAllSubmitTimeout);
