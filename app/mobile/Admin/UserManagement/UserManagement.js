...
function onBodyLoad(/* cpr.events.CEvent */ e){
	...
	totalRow.imageStyle = "/theme/images/mobile/user_list_icon_people_white.png";
	totalRow.btnStyle = "/theme/images/mobile/common_cardview_btn_right_arrow_white.png"
	totalRow.GroupName = cpr.I18N.INSTANCE.message("Str_All");
	
	if (app.getAppProperty("prePage")) {
		app.lookup("header").setAppProperty("leftBtnPath", app.getAppProperty("prePage"));
	}
