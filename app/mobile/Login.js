...
function onLoginDialogLoginFail(/* cpr.events.CUIEvent */ e){
	...
	if (e.content && e.content.message) {
		app.lookup("authMessageContent").value = e.content.message;
	} else {
		app.lookup("authMessageContent").value = cpr.I18N.INSTANCE.message("Str_Common_Login_IDPWInvalid");
	}
