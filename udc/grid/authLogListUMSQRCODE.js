...
function onBodyLoad(/* cpr.events.CEvent */ e){
	...
	var grdCard = app.lookup("authLogListGrid").header.getColumn(18);
	grdCard.unbind("text");
...
function initComboAuthType() {
	...
	cmbAuthType.addItem(new cpr.controls.Item(dataManager.getString("Str_Inside"), 15)); //ACU 인사이드버튼 공유
...
function initComboAuthResult() {
	...
	cmbAuthResult.addItem(new cpr.controls.Item(dataManager.getString("Str_Success"), AuthLogResultSuccess));
		...
		cmbAuthResult.addItem(new cpr.controls.Item(dataManager.getString("Str_AuthLogResultXKeyInvalidMasterKey"), AuthLogResultXKeyInvalidMasterKey));
		cmbAuthResult.addItem(new cpr.controls.Item(dataManager.getString("Str_AuthLogResultXKeyInvalidTime"), AuthLogResultXKeyInvalidTime));
		cmbAuthResult.addItem(new cpr.controls.Item("인증순서오류", AuthLogResultFailPunch));
