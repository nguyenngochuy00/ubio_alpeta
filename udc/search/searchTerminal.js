...
exports.addCategory = function(label, value, isBindLang){
	var item = new cpr.controls.Item(label, value);
	if (isBindLang){
		item.bind("label").toLanguage(label);
	}
	
	app.lookup("cmbSearchCategory").addItem(item);
}
